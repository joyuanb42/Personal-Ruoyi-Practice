<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="CompanyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="公司主键" align="center" prop="coId" />
      <el-table-column label="公司名称" align="center" prop="coName" />
      <el-table-column label="公司代码" align="center" prop="coCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="公司代码" prop="coCode">
          <el-input v-model="form.coCode" placeholder="请输入公司代码" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除公司编号为"' + coIds + '"的数据项？').then(function() {
        return delCompany(coIds);
      }).then(() => {
        this.getList();
